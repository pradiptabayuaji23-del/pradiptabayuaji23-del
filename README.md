...
- 📁 **Portfolio**: Mengurasi proyek-proyek terbaik saya dalam satu galeri showcase yang interaktif.
- 🐧 **Linux Workflow**: Selalu mengoptimalkan lingkungan kerja saya di sistem operasi Linux.
